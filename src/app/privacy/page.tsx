...
export default function PrivacyPage() {
  return (
    <div className="container" style={{ padding: '60px 20px', maxWidth: 800 }}>
      <h1 style={{ fontFamily: 'Playfair Display, serif', color: 'var(--navy-deep)', marginBottom: 24 }}>Privacy Policy</h1>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 24, color: 'var(--text-secondary)', lineHeight: 1.6 }}>
        <section>
          <h2 style={{ color: 'var(--navy-deep)', fontSize: '1.2rem', marginBottom: 12 }}>1. Information We Collect</h2>
        ...
        <section>
          <h2 style={{ color: 'var(--navy-deep)', fontSize: '1.2rem', marginBottom: 12 }}>2. How We Use Your Information</h2>
        ...
        <section>
          <h2 style={{ color: 'var(--navy-deep)', fontSize: '1.2rem', marginBottom: 12 }}>3. Data Security</h2>
